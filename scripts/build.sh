...
for ARCH in arm64 x86_64; do
    swiftc -O -whole-module-optimization -module-name Sokak -swift-version 5 -sdk "$SDK" -target "$ARCH-apple-macosx13.0" \
...
codesign --force --sign - --options runtime --entitlements Resources/AdHoc.entitlements --timestamp=none "$APP"
